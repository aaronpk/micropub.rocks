...
<div class="single-column">
  ...
  <section class="content">
    ...
    <p>This is a test of creating an h-entry post in form-encoded format including a <code>photo</code> property that references a URL. Your endpoint should recognize the photo property, and either download it to your own server, or render the post with the hotlinked URL.</p>
...
photo=<?= Config::$base ?>media/city-at-night.jpg</span></pre>
  </section>
