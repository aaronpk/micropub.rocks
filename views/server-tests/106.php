...
<div class="single-column">
  ...
  <section class="content">
    ...
    <p>This is a test of creating an h-entry post in form-encoded format including a nested Microformats 2 object. While it is not expected that your endpoint be able to render this particular post, it should still store the object given.</p>
...
x-weight[type]=h-measure&amp;
x-weight[properties][num]=70.64&amp;
x-weight[properties][unit]=kg</span></pre>
  </section>
