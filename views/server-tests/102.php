...
<div class="single-column">
  ...
  <section class="content">
    ...
    <p>This is a test of creating an h-entry post in form-encoded format including two categories. The category parameters are sent using the form-encoded array syntax with numeric offset, <code>category[0]</code> and <code>category[1]</code>.</p>
